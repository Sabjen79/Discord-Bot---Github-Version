...
public class MusicClear extends Command {
    ...
    public boolean check(MessageReceivedEvent event) {
        ...
        return message.equals(Bot.config.prefix + "clear");
    }
    ...
    public void execute(MessageReceivedEvent event) {
        ...
        Bot.musicManager.getGuildAudioPlayer(event.getGuild()).scheduler.clearQueue(event);
    }
}
